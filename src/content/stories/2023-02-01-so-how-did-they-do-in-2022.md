...
W﻿e saw substantial use of these open-access titles. Divide the total use (quantified using [COUNTER 5 Total Item Requees](https://www.projectcounter.org/release-5-understanding-investigations-and-requests/)by 40, and the average number of uses in 2022 of books published in 2022 is 8,314. However, one digital project skews the picture dramatically. [Vidding: A History](https://www.fulcrum.org/concern/monographs/hq37vq792?locale=en) includes almost 150 videos on the open-source Fulcrum platform through which author Francesca Coppa traces the development of video fan fiction. The use of these individual items rolls up to account for over half of our numbers. Remove *Vidding* from the table, and the average falls to 3,826 uses on average.
